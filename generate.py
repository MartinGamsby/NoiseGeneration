...
#for f_cutoff in {1024,819,655,524,419,335,268,214,172,137,110,88,70,56}:#*0.8
    ...
    weird_ratio = ((f_cutoff+150) / 750)#hz_min)
...
sf.write(f"brown_noise{f_cutoff}.mp3", brown_noise.astype(np.float32), sampling_rate, format='MP3')
